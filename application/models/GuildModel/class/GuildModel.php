...
class GuildModel extends Model {
    ...
    const TABLE_HEADER_PROGRESSION = array(
            ...
            array('header' => 'WR',             'key' => '_worldRankImage',  'class' => 'text-center border-left hidden-xs'),
            ...
            array('header' => 'QP',             'key' => '_QP',              'class' => 'text-center border-left hidden-xs hidden-sm'),
            ...
            array('header' => 'Kill Videos',    'key' => '_videoLink',       'class' => 'text-center border-left hidden-xs'),
    ...
    const TABLE_HEADER_TIMELINE = array(
            ...
            array('header' => 'Date Completed', 'key' => '_datetime',        'class' => 'text-center'),
            array('header' => 'Dungeon',        'key' => '_dungeon',         'class' => 'text-center border-left hidden-xs'),
