...
class StandingsModel extends Model {
    ...
    const TABLE_HEADER_STANDINGS_DUNGEON = array(
            ...
            array('header' => 'Progress',        'key' => '_progress',        'class' => 'border-left'),
    ...
    const TABLE_HEADER_STANDINGS_ENCOUNTER = array(
            ...
            array('header' => 'Guild',           'key' => '_nameLink',        'class' => ''),
            array('header' => 'Server',          'key' => '_serverLink',      'class' => ''),
            array('header' => 'Date Completed',  'key' => '_datetime',        'class' => 'border-left text-center'),
            ...
            array('header' => 'WF',              'key' => '_worldRankImage',  'class' => 'border-left text-center hidden-xs'),
            ...
            array('header' => 'Kill Video',      'key' => '_videoLink',       'class' => 'border-left text-center hidden-xs hidden-sm'),
