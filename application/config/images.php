...
define('IMG_ARROW_TREND_UP_LRG',   "<img style='height:30px; width:30px;'   src='" . FOLD_GRAPHICS . "icon_trend_up_large.png' class='trend-icon                alt='T-Up'>");
define('IMG_ARROW_TREND_DOWN_LRG', "<img style='height:30px; width:30px;'   src='" . FOLD_GRAPHICS . "icon_trend_down_large.png'class='trend-icon               alt='T-Down'>");
